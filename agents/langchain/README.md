...
| [Multimodal Financial Report Analyst](financial-report-analyst/) | Upload financial reports/decks/spreadsheets/images → extract text/tables/KPIs + Cosmos vision → cited answers via Deep Agent + specialist subagents | LangChain deepagents · Nebius TF (Nemotron + Cosmos) · FastAPI · Astro · SQLite |
